...
#ted2 {
background-color: DeepSkyBlue; font-weight: bold;
size:100px; font-family: inherit; padding-top: 45px;
color:white; height: 100px; width: 170px;
}
</style>
...
<body style="background-color:white;">
	...
	<div class="container"style="height: 200px; width: 50%; text-align: center;">	
		...
		<h4 style="text-align:left;">Customers were also intrested in :</h4>
	</div>
<hr>
	...
	<div class="container"style="height: 200px; width: 50%; text-align: center;">		
		...
		<c:forEach var = "i" begin = "0" end = "1">
		 ...
		 <c:if test="${empty books}"> <h1>Seems that it couldnt read DB</h1></c:if>
	</div>
